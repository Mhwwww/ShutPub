...
output "broker_upload_command" {
  value = "scp /Users/minghe/test/target/Broker.jar debian@${google_compute_instance.broker.network_interface.0.access_config.0.nat_ip}:~"
}

output "publisher_upload_command" {
  value = "scp /Users/minghe/test/target/Publisher.jar debian@${google_compute_instance.publisher.network_interface.0.access_config.0.nat_ip}:~"
}

output "subscriber_upload_command" {
  value = "scp /Users/minghe/test/target/Subscriber.jar debian@${google_compute_instance.subscriber.network_interface.0.access_config.0.nat_ip}:~"
}
