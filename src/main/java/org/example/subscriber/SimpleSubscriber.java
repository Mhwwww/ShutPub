...
//            MessageConsumer messageConsumer4 = null;
            ...
            try {
                ...
                messageConsumer1 = session.createConsumer(destination, "messageContent='A'", false);
//                messageConsumer2 = session.createConsumer(destination, "messageContent='noID'", false);
...
//                        metricsCollector.logTimestamp("msgLatency", timeRev-timeSent);
                        metricsCollector.logTimestamp(messageReceived.getText(),timeRev);
